...
> **Personal fork note:** I'm primarily using this for the cheminformatics and proteomics skill sets. If you're here for the same, the most relevant skills for small-molecule drug discovery workflows are under `skills/cheminformatics/` and `skills/proteomics/`.
