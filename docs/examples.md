...
# NOTE: I've found that bumping the result limit to 500 (default is 100) helps avoid
# missing less-common scaffolds that still have good potency. Worth the extra query time.
```
